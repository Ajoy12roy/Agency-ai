...
const Hero = ({theme}) => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4
     sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-900 dark:text-white'>
...
className='inline-flex items-center gap-2 border
 border-gray-400 rounded-full p-1.5 pr-3 '>
    <img className='w-19' src={assets.group_profile} alt="" />
    <p className='text-xs text-gray-700 font-bold '>Trusted by 10K people</p>
</motion.div>
...
xl:leading-[95px] max-w-5xl ${theme === 'dark' ? 'text-white' : 'text-gray-900' }`}>
