...
const Footer = ({theme}) => {
  return (
    ...
    className='bg-state-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
...
className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
    ...
    className='text-gray-600 dark:text-gray-400'>
      ...
      <p className='text-sm mt-2 mb-6'>The latest news, articals, and resources,sent your inbox weekly</p>
...
<hr className='border-gray-500 dark:gray-600 my-6' />
...
className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4'>
  <p>Copyright © 2025 agency.io - All Right Reserved </p>
  <div className='flex items-center justify between gap-4 flex-warp'>
